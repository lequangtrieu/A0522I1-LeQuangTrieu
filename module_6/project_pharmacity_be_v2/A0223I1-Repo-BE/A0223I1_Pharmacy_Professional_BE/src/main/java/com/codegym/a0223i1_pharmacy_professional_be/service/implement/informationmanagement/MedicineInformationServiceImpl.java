...
public class MedicineInformationServiceImpl implements MedicineInformationService {
    ...
    @Override
    public List<Medicine> findMedicinesBySelectedAttributeAndTextField(String medicineId, String medicineGroup, String medicineName, String activeIngredient,
                                                                       Float importPrice, Float retailPrice, Float wholesalePrice, String selectedAttribute, String textField) {
        return medicineInformationRepository.findMedicinesBySelectedAttributeAndTextField(
