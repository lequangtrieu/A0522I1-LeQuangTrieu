            ...
            <Container>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="ms-auto">
                        ...
                        <NavLink to="/createStudent" className="nav-link" activeClassName="active">Create Student</NavLink>
                        <NavLink to="/updateStudent" className="nav-link" activeClassName="active">Update Student</NavLink>
